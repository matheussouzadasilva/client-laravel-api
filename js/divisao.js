class Divisao
{
    ...
    static listar()
    {
        ...
        dom: "Bfrtip",        
        ajax : {
         "url": Util.url_base_api()+'divisoes',
         "dataType": 'json',
         "type": "GET",
    ...
    static detalhe(codigo)
    {
        ...
        xhr.open("GET",Util.url_base_api()+"divisoes/"+codigo,true);
    ...
    static confirmar(codigo)
    {
        ...
        if (ok && xhr != undefined) {
            ...
            if(mensagem == "") {
                xhr.open("DELETE",Util.url_base_api()+"divisoes/"+codigo, true);
                xhr.setRequestHeader("Content-Type", "application/json;charset=UTF-8");
                xhr.onreadystatechange = function() {
    ...
    static cadastrar(form) 
    {
        ...
        if (mensagem == "" && xhr != undefined) {
            xhr.open("POST",Util.url_base_api()+"divisoes",true);
            xhr.setRequestHeader("Content-Type", "application/json;charset=UTF-8");
            xhr.onreadystatechange = function() {
    ...
    static atualizar(form) 
    {
        ...
        if(mensagem == "" && xhr != undefined) {
            xhr.open("PUT",Util.url_base_api()+"divisoes/"+codigo,true);
            xhr.setRequestHeader("Content-Type", "application/json;charset=UTF-8");
            xhr.onreadystatechange = function() {
